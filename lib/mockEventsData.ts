...
export const MOCK_ORGANIZATIONS: Record<string, Organization> = {
  ...
  sae: {
    ...
    groups: [
      ...
      { id: 'g-exec-sae', name: 'Exec Board', memberCount: 9, memberIds: [] },
      { id: 'g-bros-sae', name: 'Brothers', memberCount: 51, memberIds: [] },
      { id: 'g-new-sae', name: 'New Members', memberCount: 14, memberIds: [] },
      { id: 'g-rush-sae', name: 'Fall 2026 Rush List', memberCount: 58, memberIds: [] },
...
/** Sigma Alpha Epsilon season slate — seeds Manage → Events */
export const SAE_SEED_EVENTS: EventItem[] = [
  {
    id: 'sae-rush-open-house',
    day: 'Thursday, September 10, 2026',
    time: '7:00 PM – 9:00 PM',
    endTime: '9:00 PM',
    name: 'Fall Rush: Open House',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'The SAE House',
    description: 'The first open night of Fall Rush. Come by the house, meet the brothers, eat something, and see what the chapter is actually like. No sign-up required and nothing formal — just show up. Anyone interested in rushing should start here.',
    summary: 'The first open night of Fall Rush. Come by the house, meet the brothers, and see what the chapter is actually like.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'campus',
    eligibleCampuses: ['georgetown'],
    ...
    declinedCount: 6,
    publishStatus: 'published',
    image: '/Posh/SAEFallRush.png',
    flyerUrl: '/Posh/SAEFallRush.png',
    tags: ['Greek', 'Rush', 'Open to Campus'],
    creatorId: 'cole',
  },
  {
    id: 'sae-champagne-shackles',
    day: 'Thursday, September 10, 2026',
    ...
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'Georgetown Neighborhood — Location Shared with Confirmed Attendees',
    description: 'Join SAE for Champagne & Shackles, one of the chapter’s fall rush events. Meet the brothers, spend the evening with the chapter, and get a better feel for SAE as rush continues.\n\nAttendance is limited to invited prospective members. RSVP through Ligo to confirm your spot and receive the location and final event details before Thursday night.\n\nRSVP Deadline: Thursday, September 10 at 4:00 PM\nArrival Window: 8:00–8:45 PM\nGuest Policy: Invited prospective members only\nLocation: Released to confirmed attendees',
    summary: 'Join SAE for Champagne & Shackles, one of the chapter’s fall rush events. Meet the brothers and spend the evening with the chapter.',
    category: 'campus',
    color: '#4B0082',
    ...
    pendingCount: 12,
    declinedCount: 2,
    selectedSubgroups: ['g-all-sae', 'g-bros-sae'],
    publishStatus: 'published',
    image: '/Posh/Champagne&Shackles.png',
    flyerUrl: '/Posh/Champagne&Shackles.png',
    tags: ['Greek', 'Rush', 'Invite Only', 'Smart Casual'],
    creatorId: 'kahn',
  },
  {
    id: 'sae-white-party',
    ...
    endTime: '6:00 PM',
    name: 'SAE White Party',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'Georgetown Neighborhood — Location Shared with Confirmed Guests',
    description: 'SAE White Party returns for an afternoon in Georgetown. Come dressed in white for one of the first major socials of the fall, with music, drinks, and a full Saturday crowd.\n\nThis event is invite only. RSVP to confirm attendance and receive the location and day-of details. Capacity is limited, and entry information will only be shared with confirmed guests.',
    summary: 'SAE White Party returns for an afternoon in Georgetown. Come dressed in white for one of the first major socials of the fall.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'invite_only',
    eligibleCampuses: ['georgetown'],
    ...
    pendingCount: 32,
    declinedCount: 5,
    selectedSubgroups: ['g-all-sae'],
    publishStatus: 'published',
    image: '/Posh/SAEWhiteParty.png',
    flyerUrl: '/Posh/SAEWhiteParty.png',
    tags: ['Greek', 'Social', 'Invite Only', 'Dress Code: White'],
    creatorId: 'cole',
  },
  {
    id: 'sae-standard-venue',
    day: 'Saturday, September 26, 2026',
    time: '10:00 PM – 2:00 AM',
    endTime: '2:00 AM',
    name: 'SAE at The Standard',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'The Standard',
    description: 'Venue night downtown. Tickets are on Posh as usual — this page is only for the chapter headcount, bus list, and pregame details. Do not repost the venue anywhere public.',
    summary: 'Venue night downtown. Tickets are on Posh — this page is for the chapter headcount and pregame details.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'members_only',
    eligibleCampuses: [],
    ...
    selectedSubgroups: ['g-all-sae'],
    publishStatus: 'published',
    image: '/Posh/SAEAtTheStandard.png',
    flyerUrl: '/Posh/SAEAtTheStandard.png',
    tags: ['Greek', 'Venue', 'Ticketed on Posh'],
    creatorId: 'cole',
  },
  {
    id: 'sae-paddy-murphy',
    day: 'Saturday, October 10, 2026',
    time: '9:00 PM – 1:00 AM',
    endTime: '1:00 AM',
    name: 'Paddy Murphy Week: The Dance',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'Riggs Library',
    description: 'The capstone of Paddy Murphy Week. Prohibition-era dress encouraged — the procession runs through campus Friday afternoon, and the dance closes out the week Saturday night. Every dollar at the door goes to Children’s Miracle Network. Open to all of Georgetown.',
    summary: 'The capstone of Paddy Murphy Week. Prohibition dress, doors at nine, and every dollar goes to Children’s Miracle Network.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'campus',
    eligibleCampuses: ['georgetown'],
    ...
    declinedCount: 9,
    publishStatus: 'published',
    image: '/Posh/PaddyMurphyWeek.png',
    flyerUrl: '/Posh/PaddyMurphyWeek.png',
    tags: ['Greek', 'Philanthropy', 'Open to Campus'],
    creatorId: 'cole',
  },
  {
    id: 'sae-brotherhood-retreat',
    day: 'Friday, October 23, 2026',
    time: '4:00 PM – Sunday 12:00 PM',
    endTime: '12:00 PM',
    name: 'Fall Brotherhood Retreat',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'Shenandoah — cabin TBD',
    description: 'Two nights in Shenandoah with the new member class. Vans leave campus Friday at four. We need a hard count by the fifteenth to book cabins, so respond even if the answer is no.',
    summary: 'Two nights in Shenandoah with the new member class. Hard count needed by the fifteenth.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'members_only',
    eligibleCampuses: [],
    ...
    pendingCount: 21,
    declinedCount: 7,
    selectedSubgroups: ['g-all-sae', 'g-new-sae'],
    publishStatus: 'upcoming',
    image: '/Posh/SAERetreat.png',
    flyerUrl: '/Posh/SAERetreat.png',
    tags: ['Greek', 'Brotherhood', 'Members Only'],
    creatorId: 'cole',
  },
  {
    id: 'sae-fall-formal',
    day: 'Saturday, November 21, 2026',
    time: '8:00 PM – 12:00 AM',
    endTime: '12:00 AM',
    name: 'SAE Fall Formal',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'Private Venue — Washington, DC',
    description: 'SAE Fall Formal closes out the semester with a night downtown for brothers and their dates. Formal attire required. Transportation and final venue details will be shared with confirmed attendees closer to the event.\n\nPlease RSVP by November 13 so the social committee can finalize transportation and venue numbers. Each brother should RSVP for himself and confirm his date when prompted.',
    summary: 'SAE Fall Formal closes out the semester with a night downtown for brothers and their dates. Formal attire required.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'members_only',
    eligibleCampuses: [],
    ...
    selectedSubgroups: ['g-all-sae', 'g-bros-sae'],
    publishStatus: 'upcoming',
    image: '/Posh/SAEFallFormal.png',
    flyerUrl: '/Posh/SAEFallFormal.png',
    tags: ['Greek', 'Formal', 'Brothers + Dates'],
    creatorId: 'cole',
  },
  {
    id: 'sae-chapter-meeting',
    ...
    hostAvatarColor: '#4B0082',
    venue: 'The SAE House',
    description: 'Weekly chapter. Rush numbers, dues status, and the calendar through October. Attendance counts toward good standing, so mark yourself going or not going.',
    summary: 'Weekly chapter. Rush numbers, dues status, and the calendar through October.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'members_only',
    eligibleCampuses: [],
    ...
    pendingCount: 19,
    declinedCount: 4,
    selectedSubgroups: ['g-all-sae', 'g-exec-sae', 'g-bros-sae', 'g-new-sae'],
    publishStatus: 'upcoming',
    image: '/Posh/SigEpFrat.png',
    flyerUrl: '/Posh/SigEpFrat.png',
    tags: ['Greek', 'Chapter', 'Members Only'],
    creatorId: 'cole',
  },
  {
    id: 'sae-parents-brunch',
    day: 'Saturday, November 7, 2026',
    time: '11:00 AM – 2:00 PM',
    endTime: '2:00 PM',
    name: 'Parents Weekend Brunch',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'The SAE House',
    description: 'Brunch at the house for Parents Weekend. Still working out catering and the alumni invite list before this goes out.',
    summary: 'Brunch at the house for Parents Weekend. Catering and alumni list still being worked out.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'campus',
    eligibleCampuses: ['georgetown'],
    ...
    flyerUrl: '/Posh/YoungAlumni.png',
    tags: ['Greek', 'Parents Weekend'],
    creatorId: 'cole',
  },
];

INITIAL_EVENTS.push(...GPB_SEED_EVENTS);
INITIAL_EVENTS.push(...SAE_SEED_EVENTS);
