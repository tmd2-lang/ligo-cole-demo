...
export const SAE_SEED_EVENTS: EventItem[] = [
  ...
  {
    id: 'sae-rush-round-two',
    day: 'Wednesday, September 16, 2026',
    time: '8:00 PM – 11:00 PM',
    endTime: '11:00 PM',
    name: 'Rush Round Two: Wings and Pool',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'Rhino Bar',
    description: 'Second round of rush. Smaller group than the open house, so brothers should actually show up and talk to people. Wings and pool are covered by the chapter. Exec needs a real headcount by Monday.',
    summary: 'Second round of rush. Smaller group, so brothers should show up and talk to people.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'members_only',
    eligibleCampuses: [],
    ...
    pendingCount: 12,
    declinedCount: 2,
    selectedSubgroups: ['g-exec-sae', 'g-bros-sae'],
    publishStatus: 'upcoming',
    image: '/Posh/Classof27.png',
    flyerUrl: '/Posh/Classof27.png',
  ...
  },
  {
    ...
    flyerUrl: '/Posh/TheBlackAffair.png',
