...
export const SAE_SEED_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    endTime: '9:00 PM',
    name: 'Paddy Murphy Fight Night',
    host: 'Sigma Alpha Epsilon',
    hostName: 'Sigma Alpha Epsilon',
    hostOrganizationId: 'sae',
    hostAvatar: 'SAE',
    hostAvatarColor: '#4B0082',
    venue: 'McDonough Arena',
    description: 'Our annual philanthropy night benefiting the Children’s Miracle Network. Open to all of Georgetown. Doors at six, first bout at seven, and every dollar at the door goes to CMN.',
    summary: 'Annual philanthropy night benefiting the Children’s Miracle Network. Open to all of Georgetown.',
    category: 'campus',
    color: '#4B0082',
    visibility: 'campus',
    eligibleCampuses: ['georgetown'],
